...
> {
  ...
  render(): ReactNode {
    ...
    const handleRedirectToUSMobileShop = () => {
      window.location.replace('https://spikes-shop-next.app.nonprod.usmobile.com/shopnext/shop');
    };
        ...
        <div className="layout-main">
          <div className="orderConfirmation">
            ...
            <div className="continueButtonContainer">
              ...
              {/*    </Button>*/}
              {/*</form>*/}
              <Button onClick={handleRedirectToUSMobileShop} variant={ButtonVariant.Secondary}>
                <TranslatedString id="order_confirmation.continue_shopping" />
              </Button>
            </div>
          </div>
